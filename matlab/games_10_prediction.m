...
% 
% currentGames_player = [2, 2, 2, 2, 2, 2, 2, 2, 2, 2];   % Current games of player
...
T.g10 = categorical(T.g10,[3,2,1,0],"Ordinal",true);
rng("default")
...
currentGamesArray = array2table(currentGames, 'VariableNames',{'g1','g2','g3','g4','g5','g6','g7','g8','g9','g10'});
...
% % For player
% logicalMask = all(dataMatrix_player(:,1:10) == currentGames_player, 2);
...
% logicalMask = all(dataMatrix_opponent(:,1:10) == currentGames_opponent, 2);
% ind = find(logicalMask);
% totalResult = 0;
% for i=1:1:length(ind)
